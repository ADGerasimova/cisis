...
def calculate_pressure_corrected(pressure_raw_kpa, temperature_c,
    ...
    # ⭐ v3.89.0: высоту барометра считаем один раз и используем её же как
    # дефолт для h_journal, если вызывающий код не передал свою высоту.
    # Это даёт delta_h = 0 в случае «журнал ведётся там же, где стоит
    # барометр» — именно так работают большинство точек записи.
